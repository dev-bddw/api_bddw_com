...
DEFAULT_FROM_EMAIL = env(
    ...
    default="bddw dot com api <noreply@api.bddw.com>",
)
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/app/logs/my_log_file.log',
            'formatter': 'verbose',
        },
    },
    'loggers': {
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa: F405
    {"url": "https://api.bddw.com", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
